...
import cn.iwenddg.libnavannotation.ActivityDestination;
import cn.iwenddg.libnavannotation.FragmentDestination;

/**
 * 注解处理器，在src/main/assets/生成对应的json文件
 *
 * @author iwen大大怪
...
@SupportedAnnotationTypes({"cn.iwenddg.libnavannotation.FragmentDestination", "cn.iwenddg.libnavannotation.ActivityDestination"})
